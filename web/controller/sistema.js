...
/**
*
*Abaixo está o  script para chamar as páginas de menu e cabeçalho para qualquer uma das páginas principais.
*Não sei se está correto , então precisa de uma revisão
*
*/
function carregaMenu(){
	$("#includeCabecalho").load("Cabecalho.html");
